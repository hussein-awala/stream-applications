...
public class JoinTable2WithHudiTable {
    ...
    public static void main(String[] args) throws RestClientException, IOException, StreamingQueryException {
        SparkConf sparkConf = new SparkConfBuilder("Upsert Kafka Stream to Hudi", "local[1]")
                .addS3Conf()
                .addHudiConf()
                .addHiveConf()
                .build();
        ...
        Map<String, String> hudiTableOptions1 = HudiConf.createHudiConf(
                hudiTableName1,
                tableKey1,
                precombineKey1,
                partitionKeys1,
        ...
        Map<String, String> hudiTableOptionsRes = HudiConf.createHudiConf(
                hudiTableNameRes,
                tableKeyRes,
                precombineKeyRes,
                partitionKeysRes,
        ...
        Dataset<Row> table1HudiTable = spark.read().table(String.format("%s.%s", hudiDbName1, hudiTableName1));

        Dataset<Row> joinedDf = table2Df.as("table2")
                .join(
